...
import { X, Camera as CameraIcon, TreePine } from "lucide-react";
...
const TreeIdentifier = () => {
  ...
  const mode: 'plant' = 'plant'; // Use plant mode for tree identification
    ...
    <div className="fixed inset-0 bg-black z-50 pb-20">
      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute top-16 left-4 right-4 flex justify-center">
          <div className="bg-green-700/80 backdrop-blur-sm px-4 py-2 rounded-full">
            <div className="flex items-center gap-2 text-white">
              <TreePine className="w-5 h-5" />
              <span className="font-semibold">Tree Identifier</span>
            </div>
          </div>
        </div>
